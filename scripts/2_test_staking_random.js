...
async function main(_config = {}) {
    ...
    for (let i = 0; i < total_rebase; i++) {
        ...
        for (let j = 0; j < users.length; j++) {
            ...
            switch(userActions[j]) {
                case 0:
                    ...
                    console.log("User", j+1, "staked", amount, "and haven't claimed!");
                    break;
                case 1:
                    ...
                    console.log("User", j+1, "staked", amount, "and claimed!");
                    break;
                case 2:
                    tx = await staking.connect(currentUser).claim(currentUser.address);
                    if (tx > 0)
                        console.log("User", j+1, "claimed his staked");
                    else
                        console.log("User", j+1, "has nothing to claim!");
                    break;
                case 3:
                    ...
                    if (tx > 0)
                        console.log("User", j+1, "unstaked his staked");
                    else
                        console.log("User", j+1, "unstaked more than what he has!");
                    break;
                case 4:
                    tx = await staking.connect(currentUser).forfeit();
                    console.log("User", j+1, "forfeit his unclaimed staked!")
                    break;
                default:
                    break;
            }
        ...
        if (true) {
            ...
            // Log index
            console.log("Index", counter++, ':', ethers.utils.formatUnits(await sOHM.index(), 9));
            console.log("----------");
        }
